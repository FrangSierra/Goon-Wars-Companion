...
fun WelcomeScreen(
    ...
    WelcomeScreenContent(scaffoldState, onWalletsDone, navigateToHome)
...
fun WelcomeScreenContent(
    ...
    AppScaffold(scaffoldState = scaffoldState) {
        WelcomeContent(onWalletsDone, onSkip)
    }
}

@Preview
@Composable
fun WelcomeContent(onWalletsDone: (List<String>) -> Unit = {}, onSkip: () -> Unit = {}) {
    AppPreview {
        ...
        Column(
            ...
            Link(
                text = "I will do it later", modifier = Modifier
