...
import com.efimeral.continentalapp.ui.components.dialogs.base.buttons
import java.util.*
 ...
 * with the [MaterialDialog.dialogButtons] function
 */
class MaterialDialogButtons(private val scope: MaterialDialogScope) {
    ...
    fun button(
        ...
        val buttonText = (res?.let { stringResource(id = res) } ?: text)!!.uppercase(Locale.ROOT)
        TextButton(
            onClick = {
                onClick()
            },
