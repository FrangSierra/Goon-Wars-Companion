...
import com.durdinstudios.goonwarscollector.ui.components.dialogs.base.MaterialDialogScope

const val MATERIAL_DIALOG_TITLE = "materialDialogTitle"
const val MATERIAL_DIALOG_MESSAGE = "materialDialogMessage"
const val MATERIAL_DIALOG_INPUT = "materialDialogInput"
const val MATERIAL_DIALOG_INPUT_ERROR = "materialDialogInputError"
...
fun MaterialDialogScope.title(
    ...
    require(text != null || res != null) { "Specify a text or a resource" }
    val titleText = (res?.let { stringResource(id = res) } ?: text)!!
    var modifier = Modifier
        .fillMaxWidth()
        .testTag(MATERIAL_DIALOG_TITLE)
...
fun MaterialDialogScope.message(text: String? = null, @StringRes res: Int? = null) {
    require(text != null || res != null) { "Specify a text or a resource" }
    val messageText = (res?.let { stringResource(id = res) } ?: text)!!
    ...
    Text(
        ...
        modifier = Modifier
            ...
            .testTag(MATERIAL_DIALOG_MESSAGE)
    )
}
    ...
    Column(modifier = Modifier.padding(start = 24.dp, end = 24.dp, top = 8.dp, bottom = 8.dp)) {
        ...
        if (!valid) {
            Text(
                ...
                modifier = Modifier
                    .align(Alignment.End)
                    .testTag(MATERIAL_DIALOG_INPUT_ERROR)
            )
        }
    }
...
/**
 * Create a view in the dialog with the given content and appropriate padding
